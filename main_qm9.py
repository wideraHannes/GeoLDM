...
parser.add_argument(
    "--conditioning", nargs="+", default=[], help="arguments : homo | lumo | alpha | gap | mu | Cv"
)
...
parser.add_argument(
    "--normalization_factor", type=float, default=1, help="Normalize the sum aggregation of EGNN"
)
            ...
            if nll_val < best_nll_val:
                ...
                if args.save_model:
                    ...
                    if args.ema_decay > 0:
                        utils.save_model(
                            model_ema,
                            "outputs/%s/generative_model_ema_%d.npy" % (args.exp_name, epoch),
                        )
